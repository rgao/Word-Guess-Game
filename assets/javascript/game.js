...
document.addEventListener("DOMContentLoaded", function(){
    ...
    var funfacts = ["Because of its proximity to the Sun and its lack of atmosphere, Mercury's surface experiences a temperature difference of over 500 degrees Celsius between its daytime and nighttime.",
                    ...
                    "Suffering from the gravitational stretch of Jupiter on one side and that of the other satellites on the other side, Io is the most volcanically active known wold. Io may eventually be torn apart by the tidal forces and become a part of Jupiter's rings.",
